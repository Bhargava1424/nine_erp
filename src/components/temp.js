...
function AddStudentReceipt() {
    ...
    const feeTypes = [
        { label: '1st Year Tuition Fee', key: 'firstYearTuitionFee' },
        { label: '1st Year Hostel Fee', key: 'firstYearHostelFee' },
        { label: '2nd Year Tuition Fee', key: 'secondYearTuitionFee' },
        { label: '2nd Year Hostel Fee', key: 'secondYearHostelFee' }
    ];
                    ...
                    <table className="table border border-black">
                        ...
                        <tr className="hover:bg-[#00A0E3]">
                            ...
                            <td className="text-lg text-black font-bold border border-black">
                                <button className="btn btn-outline text-white" style={{ backgroundColor: '#2D5990' }} onClick={() => handleAddReceiptClick()} >Add Receipt</button>
                                {showReceiptSection && (
                                    <div>
