...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReceiptCreateRequest', function() {
      beforeEach(function() {
        instance = new SchoolManagementSystemApi.ReceiptCreateRequest();
      });

      it('should create an instance of ReceiptCreateRequest', function() {
        // TODO: update the code to test ReceiptCreateRequest
        expect(instance).to.be.a(SchoolManagementSystemApi.ReceiptCreateRequest);
      });
