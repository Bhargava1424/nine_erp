...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendEmailRequest', function() {
      beforeEach(function() {
        instance = new SchoolManagementSystemApi.SendEmailRequest();
      });

      it('should create an instance of SendEmailRequest', function() {
        // TODO: update the code to test SendEmailRequest
        expect(instance).to.be.a(SchoolManagementSystemApi.SendEmailRequest);
      });
